...
export default async function handler(req, res) {
  ...
  const { password, from_date, to_date, extra_exclude_patterns, include_standups } = req.body || {};
  ...
  try {
    const result = await listMeetings({ from_date, to_date, extra_exclude_patterns, include_standups: !!include_standups });
